...
const InstallCard = ({data}) => {
    const {title,size,ratingAvg,image,downloads}=data;
    return (
        <div className=' bg-white p-5 mt-6 flex justify-between items-center' >
            <div className='flex  items-center gap-6'>
                <div>
                    <img className='h-30 rounded-2xl' src={image} alt="" />
                </div>
            ...
            <div>
                <button className='px-8 py-3 rounded-[6px] bg-green-400 text-white font-bold text-[18px] '>
                    Uninstall
                </button>
            </div>
        </div>
